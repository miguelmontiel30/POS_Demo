...
switch ($funcion) {
    ...
    case 'insertar_compra_temporal':
        ...
        break;
    case 'consultar_compra_temporal':
        ...
        $consulta = "SELECT productos.id_producto, productos.nombre_producto, productos.modelo_producto,
                            estados.estado,
                            detalle_orden_compra_temp.cantidad_compra, detalle_orden_compra_temp.precio_compra, 
                            detalle_orden_compra_temp.precio_venta, detalle_orden_compra_temp.precio_mayoreo
                    FROM detalle_orden_compra_temp
                    INNER JOIN productos ON detalle_orden_compra_temp.id_producto = productos.id_producto                    
                    INNER JOIN estados ON productos.id_estado = estados.id_estado                    
                    WHERE detalle_orden_compra_temp.id_estado = ?;";
